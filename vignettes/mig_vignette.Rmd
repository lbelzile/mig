...
The optimal bandwidth matrix, which minimizes the asymptotic mean squared error, depends on the Hessian and Laplacian of the unknown density function with respect to the data.

# Random number generation
 
## Rejection sampling
 
While Minami (2005) provides a constructive characterization of the inverse Gaussian as the hitting time of a particular hyperplane by a correlated Brownian motion, simulation requires discretization of the latter, and more accurate simulations come at increased costs. We turn instead to rejection sampling, using as proposal densities
...
\end{align*}
The hessian of the density is easily derived as
\begin{align*}
